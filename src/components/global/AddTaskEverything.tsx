import { View, Text, Image, Animated, Platform, TouchableOpacity, StyleSheet, ScrollView, TouchableWithoutFeedback, Modal, ActivityIndicator, Alert } from 'react-native'
